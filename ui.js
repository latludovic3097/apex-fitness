...
function rHome(){
  ...
  <h2 class="sec-title">Programme Push-Pull-Legs</h2>
  ...
  <div class="card week-card">
    <div class="week-intro">Idéal scientifique : <b>6 séances/semaine</b>, 2× chaque muscle, <b>48 à 72 h</b> de récupération par groupe. À adapter à ton agenda — <b>c'est une suggestion, pas une obligation</b>.</div>
    <div class="week-source">Schoenfeld 2016 · Helms 2014 · Lasevicius 2018</div>
    ...
    <div class="week-foot">Si 6 séances c'est trop : <b>3 par semaine</b> (Lun Push, Mer Pull, Ven Legs) reste très efficace pour la majorité des intermédiaires. Les jours de repos sont parfaits pour Cardio léger ou Core.</div>
  </div>
  ...
  return `<div class="card"><div style="font-size:14px;font-weight:700;margin-bottom:6px">🎨 Programme personnalisé</div>
    ...
    ${(typeof WODS!=="undefined" && WODS.custom && WODS.custom.length)?`
      <div style="margin-top:18px;padding-top:14px;border-top:1px solid var(--bd)">
        <div style="font-size:13px;font-weight:700;margin-bottom:4px;display:flex;align-items:center;gap:6px"><span style="font-size:14px">🔥</span>WOD optionnel</div>
